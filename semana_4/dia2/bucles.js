...
const contarVocales = (frase) => {
  ...
  const hallarDivisoresComunes = (numero1, numero2) => {
    //para poder usar una funcion que he creado solamente llamarla por su nombre
    //*primerosDivisores = [1,2,5,10]

    //1.creo un array vacio
    const arrayDivisores = [];
    //2.He creado una variable llamada primeros divisores
    //3.Quiero que esta variable se guarden los divisoress del primer grado
  ...
  //* @param {*} divisores
  //* @param 
  //* retorna un array con los divisores del parametro
